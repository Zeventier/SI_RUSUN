...
<main>
    <section>
        <div class="container" style="margin-top: 40px;">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">DAFTAR PENGHUNI RUSUN</h2>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Cell 4</td>
                                    <td>Cell 5</td>
                                    <td class="text-center"><button class="btn btn-primary" type="button" style="margin-right: 10px;">Hapus dari Portal</button><button class="btn btn-primary" type="button">Edit</button></td>
                                </tr>
                                <tr>
                                    <td>Cell 4</td>
                                    <td>Cell 3</td>
